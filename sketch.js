...
input=createInput().attribute("placeholder", "Enter your name please ")
...
H.position(425,10)
A=createElement("h1")
A.html("could you can answer these  ")
A.position(300,50)
B=createElement("h1")
B.html("Questions ")
B.position(425,100)
C=createElement("h2")
C.html("Q1) Whats starts as e and ends with e but only has one letter")
C.position(50,200)
D=createElement("h2")
D.html("a) everyone")
D.position(50,250)
